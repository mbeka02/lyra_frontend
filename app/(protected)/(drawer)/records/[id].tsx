    ...
    return (
      <SafeAreaView className="flex-1 bg-white dark:bg-black">
        ...
        <View className="flex-row justify-between items-center px-4 py-4">
          ...
          <Text className="font-semibold text-lg text-center flex-1 text-black dark:text-white">
            Loading...
          </Text>
          <View className="w-6" />
        </View>
  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-black">
      ...
      <View className="flex-row justify-between items-center px-4 py-4">
        ...
        <Text
          className="font-semibold text-lg text-center flex-1 text-black dark:text-white"
          numberOfLines={1}
        >
          Document Details
        </Text>
      ...
      <ScrollView className="flex-1 p-4">
        <View className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
          <View className="flex-row justify-between items-center p-4">
            <View className="px-2 py-1 rounded bg-green-100 dark:bg-green-900/20">
              <Text className="font-medium text-xs text-green-600 dark:text-green-400">
          ...
          <Text className="font-bold text-xl px-4 pb-4 text-black dark:text-white">
          ...
          {!isImageDocument(document) && (
            <View className="h-52 justify-center items-center mb-4 bg-gray-50 dark:bg-gray-700">
              ...
              <Text className="font-medium text-base mt-2 text-black dark:text-white">
                PDF Document
              </Text>
            </View>
          )}
          ...
          <View className="p-4">
            <Text className="font-semibold text-base mb-4 text-black dark:text-white">
              Document Information
            </Text>

            <View className="flex-row mb-2">
              <Text className="font-normal text-sm w-20 text-gray-500 dark:text-gray-400">
                Type:
              </Text>
              <Text className="font-medium text-sm flex-1 text-black dark:text-white">
                {getDocumentTypeText(document)}
              </Text>
            </View>
          ...
          <View className="flex-row items-center p-4 bg-green-100/30 dark:bg-green-900/20">
            ...
            <Text className="font-medium text-sm ml-2 text-green-600 dark:text-green-400">
      ...
      <View className="flex-row p-4 border-t border-gray-200 dark:border-gray-700">
        <TouchableOpacity
          className="flex-1 p-4 rounded-lg items-center justify-center mx-1 flex-row bg-gray-100 dark:bg-gray-800"
          onPress={handleShare}
        >
          <Share2 color="#24AE7C" size={20} />
          <Text className="font-medium text-sm ml-1 text-black dark:text-white">
            Share
          </Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text className="font-medium text-sm ml-1 text-white">
            Manage Access
          </Text>
        </TouchableOpacity>
      </View>
